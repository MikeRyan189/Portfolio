...
function Home() {
  return (
    <div className='bg-gray-700 h-full md:h-screen flex flex-col items-center justify-center font-mono ' >
      <div className='flex flex-col items-center m-10 md:flex md:flex-row md:w-[750px] border-y-green-500 border-y-4'>
     <img src={headshot} alt='headshot' className='h-[250px] rounded-xl m-5 border-green-500 border-4 '></img>
     <div>
